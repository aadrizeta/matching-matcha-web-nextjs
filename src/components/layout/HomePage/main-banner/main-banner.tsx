        ...
        <section className='bg-main-banner w-full'>
            <div className="padding-responsive flex flex-col gap-10 lg:flex-row lg:justify-between py-10 md:py-30 lg:py-40">
                <div className='flex flex-col items-center lg:items-start gap-10'>
                    <h1 className='text-3xl md:text-5xl'>Una marca que nace del amor al té</h1>
                    <h2 className='hidden md:block text-2xl'>Disfruta del auténtico té matcha importado de japón</h2>
                    <ProductsButton />
                </div>
