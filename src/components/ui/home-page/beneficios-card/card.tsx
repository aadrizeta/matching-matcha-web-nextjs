...
const Beneficios = [
    {
        icon: "/icons/Iconos-beneficios/cara.svg",
    ...
    {
        icon: "/icons/Iconos-beneficios/salud.svg",
    ...
    {
        icon: "/icons/Iconos-beneficios/cintura.svg",
    ...
    {
        icon: "/icons/Iconos-beneficios/cerebro.svg",
    ...
    {
        icon: "/icons/Iconos-beneficios/antioxidantes.svg",
